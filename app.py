from Web_Scraper.text_scraper import Text_Scrapper

text_scrapper = Text_Scrapper()

text_scrapper.scrape_web_dong("http://www.moit.gov.vn/") 
...
#         """Cấu hình driver (Cấu hình cứng tại bị lỗi nếu gọi thẳng FireFox())"""
#         options = Options()
...
# website_list = ['http://www.mod.gov.vn/', 'http://www.mps.gov.vn/', 
#                 'http://www.mt.gov.vn/', #http://www.monre.gov.vn/ cai link nay ko vao dc
#                 #'http://www.mpi.gov.vn/', 
...
#                 'http://moc.gov.vn/',
#                 #'http://www.moh.gov.vn/',
#                 'http://www.cema.gov.vn/' # Trang này vô được nhưng ko bảo mật, 
#                                           # Có thể tùy vào mức độ quan trọng của bộ ngành?
#                 'https://vpcp.chinhphu.vn/',
#                 'https://thanhtra.gov.vn/'
#                 ]
# scrapper = WebScraper()
# for website in website_list:
#     scrapper.scrape_web_dong(website)
